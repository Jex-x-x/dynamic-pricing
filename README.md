...
## Алгоритм v2.3 (Two-Window + Strong Recent Override)
...
```
ПОВЫСИТЬ (стандарт): daily_ratio > 1.2 AND recent_ratio >= 1.0
  → День хороший И последний час не хуже нормы

ПОВЫСИТЬ (strong recent): daily_ratio > 1.0 AND recent_ratio > 3.0
  → День нормальный И последний час очень сильный
  → Сильный час перевешивает слабый daily
...
| Нормальный день + очень сильный час | 1.18 | 4.1 (6 заказов/час) | **RAISE** ⚡ |
